...
\item Let the population of rabbits surviving at time t be governed by the differential equation $\diff{p_\brak{t}}{t}$=$\frac{1}{2}p\brak{t}-200$.IfP\brak{0}=100,then p\brak{t} equals:
